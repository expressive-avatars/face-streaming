...
AFRAME.registerSystem('facetracking-widget', {
  ...
  init: function () {
    ...
    function onPreviewCollapse() {
      console.log('collapse')
      previewSelf.enabled = false
    }

    function onPreviewUncollapse() {
      console.log('uncollapse')
      previewSelf.enabled = true
    }

    widgetEl.addEventListener('preview_uncollapse', onPreviewUncollapse)
    widgetEl.addEventListener('preview_collapse', onPreviewCollapse)
    ...
    widgetEl.appendChild(previewSelf.canvas)
    sceneOverlay.root.appendChild(widgetEl)

    Object.assign(window, { widgetEl, previewSelf })
