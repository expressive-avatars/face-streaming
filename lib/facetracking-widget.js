...
AFRAME.registerSystem('facetracking-widget', {
  ...
  init: function () {
    ...
    iconPause.classList.add('bx', 'bx-pause')
    ...
    btnPause.addEventListener('click', () => this.el.sceneEl.emit('facetracking_action', 'pause'))
    ...
    // Add members
    Object.assign(this, { widget, sceneOverlay, previewSelf, collapsible, iconCollapse })
  },
  uncollapse: function () {
